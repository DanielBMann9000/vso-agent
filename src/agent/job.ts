...
export class JobRunner {
    ...
    private _job: ifm.JobRequestMessage;
                        ...
                        async.series(
                            [
                                ...
                                function (done) {
                                    ...
                                    plgm.afterJob(plugins, jobCtx, serviceContext, jobResult != ifm.TaskResult.Failed, function (err, success) {
    ...
    private runTasks(callback: (err: any, jobResult: ifm.TaskResult) => void): void {
        ...
        var job: ifm.JobRequestMessage = this._job;
        var serviceContext = this._serviceContext;
        var jobCtx: ctxm.JobContext = this._jobContext;
